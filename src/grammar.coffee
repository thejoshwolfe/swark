# The parser is generated by [Jison](http://github.com/zaach/jison)
...
grammar =
  ...
  # All the different types of expressions in our language. The basic unit
  # is the **Expression** -- everything that can be an expression
  ...
  Assign: [
    o 'Assignable ASSIGN Expression',                -> new Assign $1, $3, $2
    o 'Assignable ASSIGN TERMINATOR Expression',     -> new Assign $1, $4, $2
    o 'Assignable ASSIGN INDENT Expression OUTDENT', -> new Assign $1, $4, $2
  ]
  ...
  # two different symbols for functions. `->` is for ordinary
 ...
 # Function Parameters
  ...
  # An object literal is simply a list of assignments.
  Object: [
